...
const sandbox={window:{},console,document:{getElementById:()=>null},setTimeout,clearTimeout,crypto:globalThis.crypto};
...
console.log('Runtime regressions passed: request isolation, queue recovery, scoped masks, disabled audit retention.');
