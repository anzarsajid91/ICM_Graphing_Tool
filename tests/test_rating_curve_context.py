...
def test_column_quantity_hint_does_not_treat_level_as_velocity():
    assert browser_api._column_quantity_hint("level") == "level"
    assert browser_api._column_quantity_hint("Water Level") == "level"
    assert browser_api._column_quantity_hint("Velocity") == "velocity"
    assert browser_api._column_quantity_hint("vel") == "velocity"
